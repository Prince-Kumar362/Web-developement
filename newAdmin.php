    ...
    <div class="home">
        <div><br>
            ...
            <div class="inner2">
                <fieldset>
                    <h3>Admin Form</h3>
                    <form action="newadminregister.php" method="post">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td> <input type="number" placeholder="user mobile number" name="mobile" required></td>
                            </tr>
                            <tr>
                                <td> <textarea rows="3" placeholder="user address" name="address" cols="30"></textarea>
                                </td>
                            </tr>
                        </table>
