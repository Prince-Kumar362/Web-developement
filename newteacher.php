...
<body>
    ...
    <div class="home">
        <div><br>
            ...
            <fieldset>
            <h3>Teacher Form</h3>
            <form action="NewTeacherRegister.php" method="post">
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td> <input type="number" placeholder="Your Mobile number" name="mobile" required></td>
                    </tr>
                    <tr>

                        <td> <textarea rows="3" cols="30" name="address" placeholder="Your Address"></textarea></td>
                    </tr>
                </table>
                <input type="submit" value="Register" name="register" id="button">
            </form>
            <!-- <a href="https://www.facebook.com/"><img class="image" src="image/facebook.png"></a>
            <a href="https://mail.google.com/"><img class="image" src="image/google.png"></a>
            <a href="https://twitter.com/"><img class="image" src="image/twitter.png"></a> -->
        </fieldset>
            </div>
        </div>
    </div>
